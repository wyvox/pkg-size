...
import { parsePathsInput } from './lib/slice-pkg-data.js';
import * as log from './lib/log.js';
import exec from './lib/exec.js';

const COMMENT_SIGNATURE = sub('🤖 This report was automatically generated by [pkg-size-action](https://github.com/wyvox/pkg-size)');
...
(async () => {
	...
	if (sizeReport) {
		...
		if (isFork) {
			log.startGroup('📋 Size Report (fork PR — copy to post as a comment)');
			log.info(`${sizeReport}\n\n${COMMENT_SIGNATURE}`);
			log.endGroup();
			log.warning(
